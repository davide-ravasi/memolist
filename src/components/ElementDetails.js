...
const ElementDetails = (props) => {
    console.log(props);
    const {id, status, userId, color, category, link, text, name, categories, created_at} = props;
    ...
    return (
        <div key={id} className="bg-white rounded-md p-3 shadow-xl relative">
            ...
            <div className="text-gray-400 text-xs pt-2">Created: {createdAtConverted}</div>
